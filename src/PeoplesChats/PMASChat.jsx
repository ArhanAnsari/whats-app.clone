                ...
                <div className="Message_Main_container">
                    ...
                    <div className="Message_header">
                        ...
                        <NavLink to='/Chats'><ArrowBackIcon style={{ color: 'white' }} /></NavLink>
                            <img className='Message_Header_img ' src={qaid} alt="{img} " />
                        </div>
                        <div style={{ flex: '0.5', display: 'flex', flexDirection: 'column', }}>
                            <p style={{ fontWeight: 'bolder', color: 'white', paddingTop: '15px' }}>PMAS BSCS -6B</p>
                            <p className="Chatdetail_main_div_inner_div_sms">ASIM, QADIR, JAWAD...</p>
                        </div>
